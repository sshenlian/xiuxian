...
<head>
	<title>修仙秘境</title>
	<script type="text/javascript" src="<? echo $path?>js/jquery-3.6.0.min.js"></script>
	<script type="text/javascript" src="<? echo $path?>js/bootstrap.min.js"></script>
	<link rel="stylesheet" type="text/css" href="<? echo $path?>js/bootstrap.min.css">
</head>
<body>
	<ul class="nav nav-pills container" style="margin-bottom: 30px;">

		  <li role="presentation"><a href="<? echo $path?>index.php">首页</a></li>
		  	<li role="presentation"><a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">SQL注入<span class="caret"></span></a>
		      	<ul class="dropdown-menu">
		      		<li><a href="<? echo $path?>wiki/">SQL注入漏洞文档学习</a></li>
	    			<li><a href="<? echo $path?>bug/sqli/sql_union.php">SQL注入-union注入</a></li>
	      			<li><a href="<? echo $path?>bug/sqli/sql_error.php">SQL注入-报错注入</a></li>
	      			<li><a href="<? echo $path?>bug/sqli/sql_bool.php">SQL注入-bool盲注</a></li>
	      			<li><a href="<? echo $path?>bug/sqli/sql_time.php">SQL注入-时间盲注</a></li>
   				</ul>
   			</li>
